  ...
  const handleAddPet = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const sanitizedPetData = {
        ...
        species: sanitizeInput(newPet.species),
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div key={pet.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center space-x-3">
                        <div className="w-16 h-16 bg-[#0032A0]/10 rounded-full flex items-center justify-center overflow-hidden">
                            {pet.profile_picture_url ? (
                              <img 
                                src={pet.profile_picture_url} 
                                alt={pet.name}
                            ...
                            <HeartIcon className="w-8 h-8 text-[#0032A0]" />
                            )}
                          </div>
                          <div>
                        ...
                        <div className="flex space-x-2">
                          ...
                          className="text-[#0032A0] hover:text-[#0053d6] p-1 rounded transition-colors"
                            title="View Details"
                          >
                          ...
                          className="text-[#FFD700] hover:text-[#B8860B] p-1 rounded transition-colors"
                            title="Edit Pet"
                          >
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <span className="text-gray-900">{pet.breed || 'Mixed'}</span>
                        </div>
                        <div className="flex justify-between">
                        <span className="text-gray-600">Gender:</span>
                        <span className="text-gray-900 capitalize">{pet.gender || 'Unknown'}</span>
                        </div>
                        <div className="flex justify-between">
                        <span className="text-gray-600">Weight:</span>
                        <span className="text-gray-900">{pet.weight ? `${pet.weight} kg` : 'Not recorded'}</span>
                        </div>
                        {pet.date_of_birth && (
                          <div className="flex justify-between">
                      ...
                      <div className="md:hidden">
                        ...
                        <div key={appointment.id} className="p-4 border-b border-gray-200 last:border-b-0">
                            ...
                            <div className="flex space-x-2 mt-3">
                              <button className="flex-1 text-[#0032A0] hover:text-[#0053d6] text-sm font-medium">
                                View Details
                              </button>
                              {appointment.status === 'pending' && (
                ...
                <form onSubmit={handleAddPet} className="p-6 space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <option value="Rabbit" className="text-gray-900">Rabbit</option>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-stone-200">
                    ...
                    <button
                      type="submit"
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-teal-600 to-teal-700 text-white rounded-xl hover:from-teal-700 hover:to-teal-800 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                    >
                      🐾 Add Pet
                    </button>
                  </div>
