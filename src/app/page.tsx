              ...
              <div className="animate-float">
                <div className="w-full max-w-md mx-auto bg-white rounded-3xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-300">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-black">Emergency services available around the clock</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              },
              {
                ...
                rating: 5,
                text: "The 24/7 emergency service saved Luna's life. The quick response and professional care exceeded all our expectations. Highly recommended!"
              },
              {
